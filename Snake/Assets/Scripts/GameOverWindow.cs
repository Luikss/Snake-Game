...
public class GameOverWindow : MonoBehaviour {
    ...
    private void Show(bool isNewHighscore) {
        ...
        transform.Find("NewHighScoreNumber").gameObject.SetActive(isNewHighscore);
        transform.Find("NewHighScoreText").gameObject.SetActive(isNewHighscore);
        transform.Find("NewHighScoreNumber").GetComponent<TMPro.TextMeshProUGUI>().text = GameHandler.GetScore().ToString();
    }
